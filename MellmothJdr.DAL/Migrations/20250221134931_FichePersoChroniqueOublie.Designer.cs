...
namespace MellmothJdr.DAL.Migrations
{
    ...
    [Migration("20250221134931_FichePersoChroniqueOublie")]
    partial class FichePersoChroniqueOublie
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NotificationManager.Infrastructure.Entities.Partie", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("NotificationManager.Infrastructure.Entities.Partie", b =>
                {
                    ...
                    b.HasOne("NotificationManager.Infrastructure.Entities.User", "User")
                        .WithMany("Parties")
