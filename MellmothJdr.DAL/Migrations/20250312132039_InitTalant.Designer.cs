...
namespace MellmothJdr.DAL.Migrations
{
    ...
    [Migration("20250312132039_InitTalant")]
    partial class InitTalant
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MellmothJdr.DAL.Entities.FichesPersos.ChroniquesOublies.Jointures.TalentChroniquesOublies", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("TalentChroniquesOublies", (string)null);
                });
            ...
            modelBuilder.Entity("MellmothJdr.DAL.Entities.SoinStart", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("MellmothJdr.DAL.Entities.FichesPersos.ChroniquesOublies.Jointures.TalentChroniquesOublies", b =>
                {
                    b.HasOne("MellmothJdr.DAL.Entities.FichesPersos.ChroniquesOublies.VoieChroniquesOublies", "Voie")
                        .WithMany("TalentsChroniquesOubliesVoies")
                        .HasForeignKey("VoieId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("MellmothJdr.DAL.Entities.FichesPersos.ChroniquesOublies.VoieChroniquesOublies", b =>
                {
                    ...
                    b.Navigation("TalentsChroniquesOubliesVoies");
                });
